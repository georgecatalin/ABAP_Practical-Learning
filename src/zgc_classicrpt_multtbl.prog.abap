...
*& The report displays the order number, order date, payment mode, currency, order item number, and item cost and it displays also for the records that do not exist in the dependent table
*&---------------------------------------------------------------------*
REPORT zgc_classicrpt_multtbl.
  ...
  LOOP AT lt_header INTO ls_header.
    ...
    ENDLOOP.
      IF lv_flag = abap_false.
        ...
        ls_complete-paymentmode = ls_header-paymentmode.
        ls_complete-currency = ls_header-currency.
        ls_complete-orderitemnumber = ''.
        ls_complete-itemcost = ''.
        APPEND ls_complete TO lt_complete.
        CLEAR ls_complete.
      ENDIF.
      CLEAR lv_flag.
